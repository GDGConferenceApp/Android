...
public class OldMainActivity extends BaseActivity implements RecyclerViewAdapter.OnItemClickListener, AppBarLayout.OnOffsetChangedListener {
    ...
    public void onItemClick(View view) {
        DetailActivity.launch(OldMainActivity.this, view.findViewById(R.id.image));
    }
}
